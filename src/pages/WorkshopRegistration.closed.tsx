...
const WorkshopRegistration = () => {
  const WORKSHOP_REGISTRATIONS_CLOSED = true; // Set to true to close workshop registrations
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (WORKSHOP_REGISTRATIONS_CLOSED) {
      toast.error('Workshop registrations are currently closed.');
      return;
    }
        ...
        <div className="bg-white rounded-2xl p-10 md:p-12 shadow-xl border border-gray-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    disabled={WORKSHOP_REGISTRATIONS_CLOSED}
            ...
            <div className="pt-6">
              <button
                type="submit"
                disabled={loading || WORKSHOP_REGISTRATIONS_CLOSED}
                ...
                style={{ backgroundColor: WORKSHOP_REGISTRATIONS_CLOSED ? '#9ca3af' : '#1e3a8a' }}
                onMouseEnter={(e) => !loading && !WORKSHOP_REGISTRATIONS_CLOSED && (e.currentTarget.style.backgroundColor = '#1e40af')}
                onMouseLeave={(e) => !loading && !WORKSHOP_REGISTRATIONS_CLOSED && (e.currentTarget.style.backgroundColor = '#1e3a8a')}
              >
                {loading ? (
                  <>
